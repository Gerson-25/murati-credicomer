...
import sv.com.credicomer.murativ2.ui.profile.*
import sv.com.credicomer.murativ2.ui.profile.model.BirthdayAdapter
import sv.com.credicomer.murativ2.ui.profile.model.Message
import sv.com.credicomer.murativ2.ui.profile.model.ProfileAdapter
...
class ProfileFragment : Fragment() {
    ...
    private fun openDialog(email:String, fromUser:Boolean, receiver: String){
        val newMessageDialog = BirthdayDialogFragment.newInstance(email, fromUser, receiver)
        ...
        viewModel.messages.observe(viewLifecycleOwner, Observer { messages ->
            if(messages.isNullOrEmpty()){
                ...
                viewModel.users.observe(viewLifecycleOwner, Observer { users->
                    binding.recyclerviewMessages.adapter = BirthdayAdapter(messages, users, viewModel, isMyUser)
                })
            }
        })
    ...
    private fun loadAchievements(email: String){
        ...
        binding.recyclerviewRecognition.adapter = ProfileAdapter(mutableListOf(), context!!)
