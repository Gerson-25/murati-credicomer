...
import sv.com.credicomer.murativ2.ui.profile.view.fragments.ProfileFragmentDirections

class AchievementsAdapter(val acknowledge: List<Acknowledge>, val fragContext:Context):RecyclerView.Adapter<AchievementsAdapter.ProfileViewHolder>(){
