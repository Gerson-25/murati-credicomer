...
class MyItemRecyclerViewAdapter(
   var values: MutableList<UserCarnet>, var onItemListClickListener: OnItemListClickListener, var color: Int,var context:Context
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.userItemContainer.setOnClickListener {
            //holder.userPhoto.borderColor = color
            //holder.userPhoto.borderWidth = 7F
            onItemListClickListener.setOnItemListClickListener(values[position])
        }
    }
